...
%             Pars
            ...
            if strcmp(XFileName(1:4),'stim')
                ...
                % commented out by Matteo 2013-09-03
%                 % A hack advised & authorized by Matteo (14/01/2013)
%                 address = java.net.InetAddress.getLocalHost;                
%                 if strcmpi(char(address.getCanonicalHostName), 'ZILLION')
%                     ScaleFactor = 6;
%                 end;
%                 % A hack advised & authorized by Matteo (20/15/2013)
%                 if strcmpi(char(address.getCanonicalHostName), 'ZEXTRA')
